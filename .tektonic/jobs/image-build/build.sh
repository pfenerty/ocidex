...
LABELS="label:org.opencontainers.image.version=$VERSION,label:org.opencontainers.image.revision=$(params.revision),label:org.opencontainers.image.created=$CREATED,label:org.opencontainers.image.source=https://github.com/pfenerty/ocidex"
...
buildctl-daemonless.sh build \
  ...
  --output "type=image,\"name=$IMAGE:sha-$SHORT_SHA,$IMAGE:main\",push=true,attestation-manifest-referrers=true,$LABELS"
rc=$?
