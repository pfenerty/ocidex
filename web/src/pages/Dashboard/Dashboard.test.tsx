...
// The five hooks return five different row types, so one loop cannot name a
// single ReturnType that satisfies them all. `never` is assignable to every
// one of them, which is exactly the "this stub is deliberately untyped" claim.
